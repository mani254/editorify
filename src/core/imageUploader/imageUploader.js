class ImageUploader {
   constructor({ containerId = null, maxImages = 5, maxFileSize = 2048, validTypes = ["image/jpeg", "image/png", "image/webp", "image/gif"] }) {
   ...
   createContainer() {
      ...
      // this.container.style.paddingTop = "300px";
   ...
   render() {
      ...
      if (this.previewImages.length === 0) {
         ...
         emptyState.innerHTML = `
               ...
               <div class="action-buttons">
                   <div class="file-upload">
                       ...
                       <input type="file" multiple accept="image/jpeg,image/png,image/webp,image/gif" onchange="${(e) => this.handleFileChange(e)}"/>
                   </div>
                   <button class="url-toggle" onclick="${() => { this.showUrlInput = !this.showUrlInput; this.render(); }}">
                       Add From Url
                   </button>
               </div>
           `;
         ...
         if (this.previewImages.length < this.maxImages) {
            ...
            uploadButton.innerHTML = 'Add Files';
            uploadButton.onclick = () => this.handleFileChange();
